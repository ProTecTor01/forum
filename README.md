...
* **Интеграция с Hacker News**:
  - `/sync/hackernews` - синхронизация топ-новостей с Hacker News (POST запрос)
  - Автоматическое создание категорий "Hacker News", "External Link", "Ask HN"
  - Импорт до 30 топ-новостей за раз
  - Сохранение оригинальных URL и ID из Hacker News
